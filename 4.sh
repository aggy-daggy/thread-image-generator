...
convert overlay_2x.png -gravity center -pointsize 55 -undercolor "#$COLOR" -fill transparent -font "ttf/TerminusTTF-4.49.2.ttf" -annotate +0+200 'like just make game' -append overlay_2x.png
